...
try {
    ...
    if ('GET' === $requestMethod) {
        ...
        if ($urlArr[1] === 'ref' && isset($urlArr[2]) && $urlArr[2] === 'request' && isset($urlArr[3]) && $urlArr[3] === 'm' && isset($urlArr[4]) && isset($urlArr[5])) {
            $result = $fnMain->getRefRequestMobile($urlArr[4], $urlArr[5]);
        } else {
            throw new Exception('[line: ' . __LINE__ . '] - Wrong GET Request');
        }
