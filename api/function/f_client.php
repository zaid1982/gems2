...
class Class_client {
    ...
    public function get_client_list () {
        try {
            ...
            foreach ($arr_dataLocal as $dataLocal) {
                ...
                $row_result['clientDesc'] = $dataLocal['client_desc'];
    ...
    public function get_client ($clientId) {
        try {
            ...
            $result['clientDesc'] = $dataLocal['client_desc'];
    ...
    public function add_client ($params) {
        ...
        try {
            ...
            if (!array_key_exists('clientDesc', $params) || empty($params['clientDesc'])) {
                throw new Exception('[' . __LINE__ . '] - Parameter clientDesc empty');
            }
    ...
    public function update_client ($clientId, $put_vars) {
        ...
        try {
            ...
            if (!isset($put_vars['clientDesc']) || empty($put_vars['clientDesc'])) {
                throw new Exception('[' . __LINE__ . '] - Parameter clientDesc empty');
            }
