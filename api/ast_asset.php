...
require_once 'class/AstAsset.php';
...
try {
    ...
    if ('GET' === $requestMethod) {
        ...
        //$fnMain->saveAudit(56, json_encode($bodyParams['assetNo']));
        $formData['errmsg'] = Constant::$asset['add'];
        DbMysql::commit();
        $formData['result'] = $result;
        $formData['success'] = true;
    }
        ...
        $fnMain->saveAudit(59, 'assetId = '.$urlArr[1]);
        DbMysql::commit();
        $formData['errmsg'] = Constant::$asset['update'];
        $formData['success'] = true;
    }
        ...
        //$fnMain->saveAudit(227, 'assetId = '.$urlArr[1]);
        DbMysql::commit();
        $formData['errmsg'] = Constant::$asset['delete'];
        $formData['success'] = true;
    } else {
