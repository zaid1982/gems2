...
require_once 'class/RefSpaceCategory.php';

$apiName = 'ref_space_category.php';
$isTransaction = false;
$formData = array('success'=>false, 'result'=>'', 'error'=>'', 'errmsg'=>'');
$result = '';
date_default_timezone_set("Asia/Kuala_Lumpur");

$fnMain = new RefSpaceCategory();
...
try {
    ...
    if ('GET' === $requestMethod) {
        ...
        DbMysql::commit();
        $formData['errmsg'] = 'Category created';
        $formData['result'] = $result;
        $formData['success'] = true;
    }
        ...
        DbMysql::commit();
        $formData['errmsg'] = 'Category updated';
        $formData['result'] = $result;
        $formData['success'] = true;
    }
        ...
        DbMysql::commit();
        $formData['errmsg'] = 'Category deleted';
        $formData['success'] = true;
    }
    else {
