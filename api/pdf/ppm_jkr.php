    ...
    if ('GET' === $request_method) {
        ...
        if (!is_null($type)) {
            if ($type === 'asset_with_ppm') {
                ...
                $result = $fn_ppm->get_total_ppm_asset($month, $year, $clientId, $siteId, $contractId, $isRoutine);
                ...
                $siteId = filter_input(INPUT_GET, 'siteId');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_total_ppm_task($month, $year, $clientId, $siteId, $contractId, $isRoutine);
                ...
                $siteId = filter_input(INPUT_GET, 'siteId');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_total_ppm_late($month, $year, $clientId, $siteId, $contractId, $isRoutine);
                ...
                $siteId = filter_input(INPUT_GET, 'siteId');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_perc_ppm_done($month, $year, $clientId, $siteId, $contractId, $isRoutine);
            }
                ...
                $month = filter_input(INPUT_GET, 'month');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_total_ppm_by_site_status($clientId, $year, $month, $isRoutine);
            }
                ...
                $month = filter_input(INPUT_GET, 'month');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_total_ppm_by_site_trade($clientId, $year, $month, $isRoutine);
            }
                ...
                $month = filter_input(INPUT_GET, 'month');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_total_ppm_by_trade($clientId, $siteId, $year, $month, $isRoutine);
            }
                ...
                $month = filter_input(INPUT_GET, 'month');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_total_ppm_by_status($clientId, $siteId, $year, $month, $isRoutine);
            }
                ...
                $month = filter_input(INPUT_GET, 'month');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_ppm_top5_execute($clientId, $siteId, $year, $month, $isRoutine);
            }
                ...
                $month = filter_input(INPUT_GET, 'month');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_ppm_bottom5_execute($clientId, $siteId, $year, $month, $isRoutine);
            }
                ...
                $month = filter_input(INPUT_GET, 'month');
                $isRoutine = filter_input(INPUT_GET, 'isRoutine');
                $result = $fn_ppm->get_ppm_average_execute_by_trade($clientId, $siteId, $year, $month, $isRoutine);
            }
