...
try {
    ...
    echo '-----------------<br/>';
    $assets = Class_db::getInstance()->db_select('z_jai_batch_ppm', array());
    foreach ($assets as $asset) {
        //var_dump($asset);
        Class_db::getInstance()->db_beginTransaction();
        $result = $fn_ppm->assign_ppm_single($asset['asset_id'], $asset['checklist_id'], $asset['start_date'], '1', $asset['ppm_group_id']);
        Class_db::getInstance()->db_delete('z_jai_batch_ppm', array('jai_id'=>$asset['jai_id']));
