...
class Constant {
    ...
    //public static $folderDebug = '../../../logs/gems2/debug/'; 
	public static $folderDebug = 'C:\xampp\htdocs\maintenance\logs\debug\\';
    //public static string $folderDebug = 'C:\xampp\logs\gems2\debug\\';
	//public static string $folderDebug = 'C:\xampp\htdocs\maintenance\logs\debug\\';
	//public static string $folderDebug = 'C:\xampp\logs\gems2\debug\\';
    ...
    //public static $folderError = '../../../logs/gems2/error/';
	//public static string $folderError = 'C:\xampp\htdocs\maintenance\logs\error\\';
    //public static string $folderError = 'C:\xampp\logs\gems2\error\\';
    //public static $folderError = '/Applications/XAMPP/logs/gems/error/';
    //public static $url = '//localhost/gems2/api/';
    public static $url = '//gfmgems.globalfm.com.my/api/';
