function SectionKpiPpns () {
    ...
    this.displayDeductedData = function () {
        ...
        if (kpiPpnsCategory === '6') {
            mzSetFieldValue('Skp6EmergencyTotal', mzFormatNumber(kpiPpns['kpiPpnsParam1']), 'text');
            mzSetFieldValue('Skp6EmergencyNonComply', mzFormatNumber(kpiPpns['kpiPpnsParam2']), 'text');
            ...
            mzSetFieldValue('Skp6UrgentTotal', mzFormatNumber(kpiPpns['kpiPpnsParam3']), 'text');
            mzSetFieldValue('Skp6UrgentNonComply', mzFormatNumber(kpiPpns['kpiPpnsParam4']), 'text');
            ...
            mzSetFieldValue('Skp6NormalTotal', mzFormatNumber(kpiPpns['kpiPpnsParam5']), 'text');
            mzSetFieldValue('Skp6NormalNonComply', mzFormatNumber(kpiPpns['kpiPpnsParam6']), 'text');
            ...
            mzSetFieldValue('Skp6AllTotal', mzFormatNumber(kpiPpns['kpiPpnsParam7']), 'text');
            mzSetFieldValue('Skp6AllNonComply', mzFormatNumber(kpiPpns['kpiPpnsParam8']), 'text');
            ...
            mzSetFieldValue('Skp10EmergencyTotal', mzFormatNumber(kpiPpns['kpiPpnsParam1']), 'text');
            mzSetFieldValue('Skp10EmergencyNonComply', mzFormatNumber(kpiPpns['kpiPpnsParam2']), 'text');
            mzSetFieldValue('Skp10UrgentTotal', mzFormatNumber(kpiPpns['kpiPpnsParam3']), 'text');
            mzSetFieldValue('Skp10UrgentNonComply', mzFormatNumber(kpiPpns['kpiPpnsParam4']), 'text');
            mzSetFieldValue('Skp10NormalTotal', mzFormatNumber(kpiPpns['kpiPpnsParam5']), 'text');
            mzSetFieldValue('Skp10NormalNonComply', mzFormatNumber(kpiPpns['kpiPpnsParam6']), 'text');
            mzSetFieldValue('Skp10AllTotal', mzFormatNumber(kpiPpns['kpiPpnsParam7']), 'text');
            mzSetFieldValue('Skp10AllNonComply', mzFormatNumber(kpiPpns['kpiPpnsParam8']), 'text');
            const allPerc = mzFormatNumber(kpiPpns['kpiPpnsParam7']) !== '0' ? mzFormatNumber(parseInt(kpiPpns['kpiPpnsParam8'])/parseInt(kpiPpns['kpiPpnsParam7'])*100,2) : '0';
