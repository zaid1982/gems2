        ...
        oTableWoSummary = $('#dtRwsWoSummary').DataTable({
            ...
            aoColumns:
                [
                    ...
                    {mData: null, sClass: 'text-right',
                        mRender: function (data, type, row) {
                            if (siteColumns.length > 0 && typeof row['open'+siteColumns[1]['siteId']] !== 'undefined') {
                    ...
                    {mData: null, sClass: 'text-right',
                        mRender: function (data, type, row) {
                            if (siteColumns.length > 0 && typeof row['closed'+siteColumns[1]['siteId']] !== 'undefined') {
                    ...
                    {mData: null, sClass: 'text-right',
                        mRender: function (data, type, row) {
                            if (siteColumns.length > 0 && typeof row['open'+siteColumns[2]['siteId']] !== 'undefined') {
                    ...
                    {mData: null, sClass: 'text-right',
                        mRender: function (data, type, row) {
                            if (siteColumns.length > 0 && typeof row['closed'+siteColumns[2]['siteId']] !== 'undefined') {
                    ...
                    {mData: null, sClass: 'text-right',
                        mRender: function (data, type, row) {
                            if (siteColumns.length > 0 && typeof row['open'+siteColumns[3]['siteId']] !== 'undefined') {
                    ...
                    {mData: null, sClass: 'text-right',
                        mRender: function (data, type, row) {
                            if (siteColumns.length > 0 && typeof row['closed'+siteColumns[3]['siteId']] !== 'undefined') {
