        ...
        try {
            ...
            setTimeout(function () {
                try {
                    ...
                    $('#lblUtilityTotalKwh').text(mzFormatNumber(monthlySummary['utilityTotalKwh']));
                    $('#lblUtilityUsageRate').text(monthlySummary['utilityUsageRate']);
                    $('#lblUtilityUsageRm').text(mzFormatNumber(monthlySummary['utilityUsageRm'],2));
                    $('#lblCajSambunganBeban').text(mzFormatNumber(monthlySummary['cajSambunganBeban']));
                    $('#lblCajSambunganBebanRate').text(monthlySummary['cajSambunganBebanRate']);
                    $('#lblCajSambunganBebanRm').text(mzFormatNumber(monthlySummary['cajSambunganBebanRm'],2));
                    $('#lblUtilityActualMaxDemand').text(mzFormatNumber(monthlySummary['utilityActualMaxDemand']));
                    $('#lblUtilityMaxDemandRate').text(mzFormatNumber(monthlySummary['kwtbbRm'],2));
                    $('#lblUtilityMaxDemandRm').text(monthlySummary['utilityMaxDemandRate']);
                    $('#lblElectricityAmountRm').text(mzFormatNumber(monthlySummary['utilityMaxDemandRm'],2));
