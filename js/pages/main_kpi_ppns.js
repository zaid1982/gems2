    ...
    this.init = function () {
        ...
        oTableKpp = $('#dtKppData').DataTable({
            ...
            columnDefs: [
                ...
                { className: 'text-right font-weight-bold', targets: [15] },
            ],
            buttons: [
            ...
            aoColumns: [
                ...
                {mData: 'kpiCate2', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_2_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate3', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_3_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate4', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_4_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate5', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_5_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate6', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_6_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate7', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_7_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate8', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_8_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate9', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_9_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate10', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_10_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate11', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_11_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate12', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_12_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate13', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_13_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCate14', mRender: function (data, type, row, meta){
                        return '<a class="text-primary lnkKppDetails" id="lnkKppDetails_14_' + meta.row + '" data-toggle="tooltip" data-placement="top" title="Deduction Details">'+data+'</a>';
                    }},
                {mData: 'kpiCateAll'}
            ]
        });
