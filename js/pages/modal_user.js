function ModalUser() {
    ...
    this.init = function () {
        ...
        $("input[name='chkMusUserType']:radio").on('click', function () {
            ...
            if ($(this).val() === '1') {
                $('.divMusRoles').show();
                $('#divMusRole1, #divMusRole19, #divMusRole2, #divMusRole3, #divMusRole4, #divMusRole5, #divMusRole7, #divMusRole8, #divMusRole9, #divMusRole10, #divMusRole11, #divMusRole12, #divMusRole13, #divMusRole14, #divMusRole16, #divMusRole17, #divMusRole18').show();
                $('#divMusRole6').hide();
            } else if ($(this).val() === '2') {
                $('.divMusRoles').show();
                $('#divMusRole1, #divMusRole19, #divMusRole2, #divMusRole3, #divMusRole4, #divMusRole5, #divMusRole7, #divMusRole8, #divMusRole9, #divMusRole10, #divMusRole11, #divMusRole12, #divMusRole13, #divMusRole14, #divMusRole16, #divMusRole17, #divMusRole18').hide();
                $('#divMusRole6').show();
        ...
        setTimeout(function () {
            try {
                ...
                if (userType === '1') {
                    ...
                    $('.divMusRoles').show();
                    $('#divMusRole1, #divMusRole19, #divMusRole2, #divMusRole3, #divMusRole4, #divMusRole5, #divMusRole7, #divMusRole8, #divMusRole9, #divMusRole10, #divMusRole11, #divMusRole12, #divMusRole13, #divMusRole14, #divMusRole16, #divMusRole17, #divMusRole18, #divMusRole11').hide();
                    $('#divMusRole6,').show();
                }
                formValidate.validateForm();
